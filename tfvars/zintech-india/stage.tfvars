...
/*
  ...
  api1 = {
    ec2_subnet_id      = "public" #"zintech-india-private-subnet-0"  # give subnet name 
    ssh_key            = "test-key-pair"
    ami_id             = "ami-0d81f2cd09b410166" #"ami-0f5ee92e2d63afc18"
    name               = "test1"
    instance_type      = "t3.micro"
  ...
  test_worker1 = {
    ec2_subnet_id      = "private" #"zintech-india-private-subnet-0"  # trying giving pub subnet id manually by picking from ui 
    ssh_key            = "test-key-pair"
    ami_id             = "ami-0d81f2cd09b410166" #"ami-0f5ee92e2d63afc18"
    name               = "test_worker1"
    instance_type      = "t3.micro"
